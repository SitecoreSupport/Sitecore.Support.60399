...
namespace Sitecore.Support.ExperienceEditor.Speak.Ribbon.Requests.Treecrumb
{
  public class ContextSite : PipelineProcessorRequest<ItemContext>
  {
    public override PipelineProcessorResponseValue ProcessRequest()
    {
      ...
      if (currentSite != null && !base.RequestContext.Argument.Contains("sc_site"))
      {
        string newUrl = base.RequestContext.Argument + "&sc_site=" + currentSite.Name;
        result.Value = newUrl;
      }
      return result;
    }
