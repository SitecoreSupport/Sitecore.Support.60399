    ...
    function (Sitecore, ExperienceEditorContext, ExperienceEditorProxy, TranslationUtil) {
        var experienceEditor = {
            ...
            navigateToItem: function (itemId) {
                ...
                postContext.currentContext.argument = url;
                experienceEditor.Web.postServerRequest("ExperienceEditor.Treecrumb.ContextSite", postContext.currentContext, function (response) {
                    var res = treecrumbUpdatedContextSite(response, experienceEditor);
                    if (!res) {
...
function treecrumbUpdatedContextSite(response, experienceEditor) {
